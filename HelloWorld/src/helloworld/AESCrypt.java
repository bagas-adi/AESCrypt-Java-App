...
//            log("Base64.NO_WRAP", encoded);
            ...
            if (DEBUG_LOG_ENABLED)
                System.out.println(TAG+" : UnsupportedEncodingException, "+e.getMessage());
    ...
    private static void log(String what, byte[] bytes) {
        if (DEBUG_LOG_ENABLED) 
            System.out.println(TAG+ what + "[" + bytes.length + "] [" + bytesToHex(bytes) + "]");
    }

    private static void log(String what, String value) {
        if (DEBUG_LOG_ENABLED) 
            System.out.println(TAG+what + "[" + value.length() + "] [" + value + "]");
    }
